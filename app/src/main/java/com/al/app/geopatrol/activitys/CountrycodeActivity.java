...
import com.al.app.geopatrol.adapter.CountryListArrayAdapter;
...
public class CountrycodeActivity extends ListActivity {
    ...
    public static String RESULT_CONTRY = "countrycode";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                returnIntent.putExtra(RESULT_CONTRY,c.getName());
